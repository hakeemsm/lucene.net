	...
	public class TestPhraseQuery : LuceneTestCase
	{
		...
		public static void BeforeClass()
		{
			...
			doc.Add(NewTextField("repeated", "this is a repeated field - first part", Field.Store
				.YES));
			IndexableField repeatedField = NewTextField("repeated", "second part of a repeated field"
				, Field.Store.YES);
		...
		public virtual void TestExact()
		{
			...
			query.Add(new Term("field", "five"));
			ScoreDoc[] hits = searcher.Search(query, null, 1000).scoreDocs;
			NUnit.Framework.Assert.AreEqual("exact match", 1, hits.Length);
			QueryUtils.Check(Random(), query, searcher);
			query = new PhraseQuery();
			query.Add(new Term("field", "two"));
			query.Add(new Term("field", "one"));
			hits = searcher.Search(query, null, 1000).scoreDocs;
			NUnit.Framework.Assert.AreEqual("reverse not exact", 0, hits.Length);
			QueryUtils.Check(Random(), query, searcher);
		}
		...
		public virtual void TestSlop1()
		{
			...
			query.Add(new Term("field", "two"));
			ScoreDoc[] hits = searcher.Search(query, null, 1000).scoreDocs;
			NUnit.Framework.Assert.AreEqual("in order", 1, hits.Length);
			QueryUtils.Check(Random(), query, searcher);
			...
			query.Add(new Term("field", "one"));
			hits = searcher.Search(query, null, 1000).scoreDocs;
			NUnit.Framework.Assert.AreEqual("reversed, slop not 2 or more", 0, hits.Length);
			QueryUtils.Check(Random(), query, searcher);
		}
		...
		public virtual void TestOrderDoesntMatter()
		{
			...
			query.Add(new Term("field", "one"));
			ScoreDoc[] hits = searcher.Search(query, null, 1000).scoreDocs;
			NUnit.Framework.Assert.AreEqual("just sloppy enough", 1, hits.Length);
			QueryUtils.Check(Random(), query, searcher);
			query = new PhraseQuery();
			query.SetSlop(2);
			...
			query.Add(new Term("field", "one"));
			hits = searcher.Search(query, null, 1000).scoreDocs;
			NUnit.Framework.Assert.AreEqual("not sloppy enough", 0, hits.Length);
			QueryUtils.Check(Random(), query, searcher);
		}
		...
		public virtual void TestMulipleTerms()
		{
			...
			query.Add(new Term("field", "five"));
			ScoreDoc[] hits = searcher.Search(query, null, 1000).scoreDocs;
			NUnit.Framework.Assert.AreEqual("two total moves", 1, hits.Length);
			QueryUtils.Check(Random(), query, searcher);
			query = new PhraseQuery();
			query.SetSlop(5);
			...
			query.Add(new Term("field", "one"));
			hits = searcher.Search(query, null, 1000).scoreDocs;
			NUnit.Framework.Assert.AreEqual("slop of 5 not close enough", 0, hits.Length);
			QueryUtils.Check(Random(), query, searcher);
			query.SetSlop(6);
			hits = searcher.Search(query, null, 1000).scoreDocs;
			NUnit.Framework.Assert.AreEqual("slop of 6 just right", 1, hits.Length);
			QueryUtils.Check(Random(), query, searcher);
		}
		...
		public virtual void TestSlopScoring()
		{
			...
			Lucene.Net.Document.Document doc3 = new Lucene.Net.Document.Document
				();
			...
			NUnit.Framework.Assert.AreEqual(0.71, hits[0].score, 0.01);
			NUnit.Framework.Assert.AreEqual(0, hits[0].doc);
			NUnit.Framework.Assert.AreEqual(0.44, hits[1].score, 0.01);
			NUnit.Framework.Assert.AreEqual(1, hits[1].doc);
			NUnit.Framework.Assert.AreEqual(0.31, hits[2].score, 0.01);
			NUnit.Framework.Assert.AreEqual(2, hits[2].doc);
			QueryUtils.Check(Random(), query, searcher);
			reader.Close();
			directory.Close();
		}
		...
		public virtual void TestToString()
		{
			...
			NUnit.Framework.Assert.AreEqual("field:\"? hi ? ? ? test\"", q.ToString());
			q.Add(new Term("field", "hello"), 1);
			NUnit.Framework.Assert.AreEqual("field:\"? hi|hello ? ? ? test\"", q.ToString());
		}
		...
		public virtual void TestWrappedPhrase()
		{
			...
			query.SetSlop(100);
			ScoreDoc[] hits = searcher.Search(query, null, 1000).scoreDocs;
			NUnit.Framework.Assert.AreEqual("slop of 100 just right", 1, hits.Length);
			QueryUtils.Check(Random(), query, searcher);
			query.SetSlop(99);
			hits = searcher.Search(query, null, 1000).scoreDocs;
			NUnit.Framework.Assert.AreEqual("slop of 99 not enough", 0, hits.Length);
			QueryUtils.Check(Random(), query, searcher);
		}
		...
		public virtual void TestNonExistingPhrase()
		{
			...
			ScoreDoc[] hits = searcher.Search(query, null, 1000).scoreDocs;
			NUnit.Framework.Assert.AreEqual("phrase without repetitions exists in 2 docs", 2, 
				hits.Length);
			QueryUtils.Check(Random(), query, searcher);
			...
			// would be found 
			hits = searcher.Search(query, null, 1000).scoreDocs;
			NUnit.Framework.Assert.AreEqual("phrase with repetitions exists in two docs", 2, 
				hits.Length);
			QueryUtils.Check(Random(), query, searcher);
			...
			hits = searcher.Search(query, null, 1000).scoreDocs;
			NUnit.Framework.Assert.AreEqual("nonexisting phrase with repetitions does not exist in any doc"
				, 0, hits.Length);
			QueryUtils.Check(Random(), query, searcher);
		...
		public virtual void TestPalyndrome2()
		{
			...
			query.Add(new Term("field", "three"));
			ScoreDoc[] hits = searcher.Search(query, null, 1000).scoreDocs;
			NUnit.Framework.Assert.AreEqual("phrase found with exact phrase scorer", 1, hits.
				Length);
			...
			NUnit.Framework.Assert.AreEqual("exact scorer and sloppy scorer score the same when slop does not matter"
		...
		public virtual void TestRewrite()
		{
			...
			NUnit.Framework.Assert.IsTrue(rewritten is TermQuery);
		}
		...
		public virtual void TestRandomPhrases()
		{
			...
			for (int i_1 = 0; i_1 < num; i_1++)
			{
				...
				NUnit.Framework.Assert.IsTrue("phrase '" + sb + "' not found; start=" + start, found
					);
			}
			reader.Close();
			dir.Close();
