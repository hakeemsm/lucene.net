...
namespace Lucene.Net.Facet.Taxonomy
{
	...
	public interface TaxonomyWriter : IDisposable, TwoPhaseCommit
	{
		...
		/// <summary>getSize() returns the number of categories in the taxonomy.</summary>
		/// <remarks>
		...
		/// <summary>Sets the commit user data map.</summary>
		/// <remarks>
		/// Sets the commit user data map. That method is considered a transaction and
		/// will be
		/// <see cref="Lucene.Net.Index.TwoPhaseCommit.Commit()">committed</see>
		...
		/// <see cref="SetCommitData(System.Collections.Generic.IDictionary{K, V})">SetCommitData(System.Collections.Generic.IDictionary&lt;K, V&gt;)
		/// 	</see>
		/// .
		/// </summary>
		IDictionary<string, string> GetCommitData();
	}
}
