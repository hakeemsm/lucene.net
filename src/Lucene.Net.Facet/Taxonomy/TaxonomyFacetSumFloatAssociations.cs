...
namespace Lucene.Net.Facet.Taxonomy
{
	...
	public class TaxonomyFacetSumFloatAssociations : FloatTaxonomyFacets
	{
		/// <summary>
		/// Create
		/// <code>TaxonomyFacetSumFloatAssociations</code>
		/// against
		/// the default index field.
		/// </summary>
		/// <exception cref="System.IO.IOException"></exception>
		public TaxonomyFacetSumFloatAssociations(TaxonomyReader taxoReader, FacetsConfig 
			config, FacetsCollector fc) : this(FacetsConfig.DEFAULT_INDEX_FIELD_NAME, taxoReader
			, config, fc)
		{
		}
		...
		/// </summary>
		/// <exception cref="System.IO.IOException"></exception>
		public TaxonomyFacetSumFloatAssociations(string indexFieldName, TaxonomyReader taxoReader
			...
			foreach (FacetsCollector.MatchingDocs hits in matchingDocs)
			{
				...
				while ((doc = docs.NextDoc()) != DocIdSetIterator.NO_MORE_DOCS)
				{
					...
					while (offset < end)
					{
						...
						offset += 4;
						values[ord] += Sharpen.Runtime.IntBitsToFloat(value);
					}
				}
			}
		}
