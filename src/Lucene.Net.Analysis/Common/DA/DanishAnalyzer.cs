...
namespace Lucene.Net.Analysis.DA
{
	...
	public sealed class DanishAnalyzer : StopwordAnalyzerBase
	{
		...
		/// <summary>File containing default Danish stopwords.</summary>
		/// <remarks>File containing default Danish stopwords.</remarks>
		public static readonly string DEFAULT_STOPWORD_FILE = "danish_stop.txt";
		...
		{
			return DanishAnalyzer.DefaultSetHolder.DEFAULT_STOP_SET;
		}
		...
		/// .
		/// </summary>
		protected internal DanishAnalyzer(Version matchVersion) : this(matchVersion, DanishAnalyzer.DefaultSetHolder
			.DEFAULT_STOP_SET)
		{
		}
		...
		protected internal DanishAnalyzer(Version matchVersion, CharArraySet stopwords) : 
		...
		public DanishAnalyzer(Version matchVersion, CharArraySet stopwords, CharArraySet 
