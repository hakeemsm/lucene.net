...
namespace Lucene.Net.Analysis.NO
{
	...
	public sealed class NorwegianAnalyzer : StopwordAnalyzerBase
	{
		...
		/// <summary>File containing default Norwegian stopwords.</summary>
		/// <remarks>File containing default Norwegian stopwords.</remarks>
		public static readonly string DEFAULT_STOPWORD_FILE = "norwegian_stop.txt";
		...
		{
			return NorwegianAnalyzer.DefaultSetHolder.DEFAULT_STOP_SET;
		}
		...
		/// .
		/// </summary>
		protected internal NorwegianAnalyzer(Version matchVersion) : this(matchVersion, NorwegianAnalyzer.DefaultSetHolder
			.DEFAULT_STOP_SET)
		{
		}
		...
		protected internal NorwegianAnalyzer(Version matchVersion, CharArraySet stopwords
		...
		public NorwegianAnalyzer(Version matchVersion, CharArraySet stopwords, CharArraySet
