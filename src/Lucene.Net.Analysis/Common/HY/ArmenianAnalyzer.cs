...
namespace Lucene.Net.Analysis.HY
{
	...
	public sealed class ArmenianAnalyzer : StopwordAnalyzerBase
	{
		...
		/// <summary>File containing default Armenian stopwords.</summary>
		/// <remarks>File containing default Armenian stopwords.</remarks>
		...
		{
			return ArmenianAnalyzer.DefaultSetHolder.DEFAULT_STOP_SET;
		}
		...
		/// .
		/// </summary>
		protected internal ArmenianAnalyzer(Version matchVersion) : this(matchVersion, ArmenianAnalyzer.DefaultSetHolder
			.DEFAULT_STOP_SET)
		{
		}
		...
		protected internal ArmenianAnalyzer(Version matchVersion, CharArraySet stopwords)
		...
		public ArmenianAnalyzer(Version matchVersion, CharArraySet stopwords, CharArraySet
