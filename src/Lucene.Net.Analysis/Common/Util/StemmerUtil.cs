...
namespace Lucene.Analysis.Util
{
    /// <summary>Some commonly-used stemming functions</summary>
    ...
    public class StemmerUtil
    {
        ...
        /// <summary>Returns true if the character array starts with the suffix.</summary>
        /// <remarks>Returns true if the character array starts with the suffix.</remarks>
        ...
        /// <summary>Returns true if the character array ends with the suffix.</summary>
        /// <remarks>Returns true if the character array ends with the suffix.</remarks>
        /// <param name="s">Input Buffer</param>
        /// <param name="len">length of input buffer</param>
        ...
        /// <summary>Delete n characters in-place</summary>
        /// <param name="s">Input Buffer</param>
        /// <param name="pos">Position of character to delete</param>
        /// <param name="len">Length of input buffer</param>
