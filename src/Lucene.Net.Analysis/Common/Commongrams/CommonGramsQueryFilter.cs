...
namespace Lucene.Net.Analysis.Commongrams
{
	...
	public sealed class CommonGramsQueryFilter : TokenFilter
	{
		...
		/// <summary>Constructs a new CommonGramsQueryFilter based on the provided CommomGramsFilter
		/// 	</summary>
		...
		/// <summary>Output bigrams whenever possible to optimize queries.</summary>
		/// <remarks>
		...
		// ================================================= Helper Methods ================================================
		/// <summary>Convenience method to check if the current type is a gram type</summary>
		/// <returns>
		/// 
		/// <code>true</code>
		/// if the current type is a gram type,
		/// <code>false</code>
		/// otherwise
		/// </returns>
