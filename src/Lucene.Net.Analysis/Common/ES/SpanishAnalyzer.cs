...
namespace Lucene.Net.Analysis.ES
{
	...
	public sealed class SpanishAnalyzer : StopwordAnalyzerBase
	{
		...
		/// <summary>File containing default Spanish stopwords.</summary>
		/// <remarks>File containing default Spanish stopwords.</remarks>
		public static readonly string DEFAULT_STOPWORD_FILE = "spanish_stop.txt";
		...
		/// .
		/// </summary>
		protected internal SpanishAnalyzer(Version matchVersion) : this(matchVersion, SpanishAnalyzer.DefaultSetHolder
			.DEFAULT_STOP_SET)
		{
		}
		...
		protected internal SpanishAnalyzer(Version matchVersion, CharArraySet stopwords) : 
		...
		public SpanishAnalyzer(Version matchVersion, CharArraySet stopwords, CharArraySet
		...
		/// provided and
		/// <see cref="SpanishLightStemFilter">SpanishLightStemFilter</see>
		/// .
		/// </returns>
