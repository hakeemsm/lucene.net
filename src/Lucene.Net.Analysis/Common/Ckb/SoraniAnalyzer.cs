...
namespace Lucene.Net.Analysis.Ckb
{
	...
	public sealed class SoraniAnalyzer : StopwordAnalyzerBase
	{
		...
		/// <summary>File containing default Kurdish stopwords.</summary>
		/// <remarks>File containing default Kurdish stopwords.</remarks>
		...
		private class DefaultSetHolder
		{
			...
			static DefaultSetHolder()
			{
				try
				{
					DEFAULT_STOP_SET = WordlistLoader.GetWordSet(IOUtils.GetDecodingReader(typeof(SoraniAnalyzer
		...
		/// .
		/// </summary>
		protected internal SoraniAnalyzer(Version matchVersion) : this(matchVersion, SoraniAnalyzer.DefaultSetHolder
			.DEFAULT_STOP_SET)
		{
		}
		...
		protected internal SoraniAnalyzer(Version matchVersion, CharArraySet stopwords) : 
		...
		public SoraniAnalyzer(Version matchVersion, CharArraySet stopwords, CharArraySet 
