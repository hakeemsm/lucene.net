...
//        private static readonly string COMPLEXPREFIXES_KEY = "COMPLEXPREFIXES";
//        private static readonly string CIRCUMFIX_KEY = "CIRCUMFIX";
//        private static readonly string IGNORE_KEY = "IGNORE";
//        private static readonly String AF_KEY = "AF";

//        private static readonly string ICONV_KEY = "ICONV";
//        private static readonly string OCONV_KEY = "OCONV";
...
//            : this(affix, new[] { dictionary },false)
//        {
//        }
...
//        /// <exception cref = "IOException">Can be thrown while reading from the streams.</exception>
//        /// <exception cref = "InvalidDataException">Can be thrown if the content of the files does not meet expected formats.</exception>
//        public HunspellDictionary(Stream affix, IEnumerable<Stream> dictionaries, bool ignoreCase)
//        {
...
//            // circumfix flag, or -1 if one is not defined
//            // ignored characters (dictionary, affix, inputs)
//            // FSTs used for ICONV/OCONV, output ord pointing to replacement text
//            this.ignoreCase = ignoreCase;
//            this.needsInputCleaning = ignoreCase;
//            this.needsOutputCleaning = false;
//            // set if we have an OCONV
//            flagLookup.Add(new BytesRef());
//            // no flags -> ord 0
//            string tempFile = System.IO.Path.GetTempFileName();
            
//            using (var sw = new BufferedStream(new FileStream(tempFile, FileMode.Open)))
//            {
...
//            }
//            // pass 1: get encoding
//            var aff1 = new BufferedStream(new FileStream(tempFile,FileMode.Open));
//            var encodingName = ReadDictionaryEncoding(affix);
//            var encoding = Encoding.GetEncoding(encodingName);
//            var aff2 = new BufferedStream(new FileStream(tempFile,FileMode.Open));
//            ReadAffixFile(aff2, encoding);
