...
//            if (_dictionary.NeedsInputCleaning)
//            {
...
//                word = scratchBuffer;
//            }
//            IList<CharsRef> stems = new AList<CharsRef>();
...
//                {
//                    stems.AddItem(NewStem(word, length));
//                }
//            }
//            Sharpen.Collections.AddAll(stems, Stem(word, length, -1, -1, -1, 0, true, true, false
//                , false));
//            return stems;
