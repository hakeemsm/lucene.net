...
namespace Lucene.Net.Analysis.Snowball
{
	...
	public class SnowballPorterFilterFactory : TokenFilterFactory, IResourceLoaderAware
	{
		...
		/// <summary>Creates a new SnowballPorterFilterFactory</summary>
		protected internal SnowballPorterFilterFactory(IDictionary<string, string> args) : 
			base(args)
		{
		...
		public virtual void Inform(IResourceLoader loader)
		{
			...
			stemClass = loader.NewInstance<SnowballProgram>(className).GetType();
			if (wordFiles != null)
			{
		...
		public override TokenStream Create(TokenStream input)
		{
			...
			try
			{
				program = System.Activator.CreateInstance(stemClass);
			}
			catch (Exception e)
			{
				throw new RuntimeException("Error instantiating stemmer for language " + language
					 + "from class " + stemClass, e);
			}
