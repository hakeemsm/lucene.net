...
namespace Lucene.Net.Analysis.LV
{
	...
	public sealed class LatvianAnalyzer : StopwordAnalyzerBase
	{
		...
		/// <summary>File containing default Latvian stopwords.</summary>
		/// <remarks>File containing default Latvian stopwords.</remarks>
		...
		{
			return LatvianAnalyzer.DefaultSetHolder.DEFAULT_STOP_SET;
		}
		...
		private class DefaultSetHolder
		{
			...
			static DefaultSetHolder()
			{
				try
				{
					DEFAULT_STOP_SET = WordlistLoader.GetWordSet(IOUtils.GetDecodingReader(typeof(LatvianAnalyzer
		...
		/// .
		/// </summary>
		protected internal LatvianAnalyzer(Version matchVersion) : this(matchVersion, LatvianAnalyzer.DefaultSetHolder
			.DEFAULT_STOP_SET)
		{
		}
		...
		protected internal LatvianAnalyzer(Version matchVersion, CharArraySet stopwords) : 
		...
		public LatvianAnalyzer(Version matchVersion, CharArraySet stopwords, CharArraySet
		...
		/// provided and
		/// <see cref="LatvianStemFilter">LatvianStemFilter</see>
		/// .
		/// </returns>
