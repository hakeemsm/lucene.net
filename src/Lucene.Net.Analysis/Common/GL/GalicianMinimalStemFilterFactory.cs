...
namespace Lucene.Net.Analysis.GL
{
	/// <summary>
	/// Factory for
	/// <see cref="GalicianMinimalStemFilter">GalicianMinimalStemFilter</see>
	/// .
	...
	{
		/// <summary>Creates a new GalicianMinimalStemFilterFactory</summary>
		protected internal GalicianMinimalStemFilterFactory(IDictionary<string, string> args) : base(args)
		{
			if (args.Any())
			{
