...
namespace Lucene.Net.Analysis.GL
{
	...
	public sealed class GalicianAnalyzer : StopwordAnalyzerBase
	{
		...
		/// <summary>File containing default Galician stopwords.</summary>
		/// <remarks>File containing default Galician stopwords.</remarks>
		...
		{
			return GalicianAnalyzer.DefaultSetHolder.DEFAULT_STOP_SET;
		}
		...
		private class DefaultSetHolder
		{
			...
			static DefaultSetHolder()
			{
				try
				{
					DEFAULT_STOP_SET = WordlistLoader.GetWordSet(IOUtils.GetDecodingReader(typeof(GalicianAnalyzer
		...
		/// .
		/// </summary>
		protected internal GalicianAnalyzer(Version matchVersion) : this(matchVersion, GalicianAnalyzer.DefaultSetHolder
			.DEFAULT_STOP_SET)
		{
		}
		...
		protected internal GalicianAnalyzer(Version matchVersion, CharArraySet stopwords)
		...
		public GalicianAnalyzer(Version matchVersion, CharArraySet stopwords, CharArraySet
		...
		/// provided and
		/// <see cref="GalicianStemFilter">GalicianStemFilter</see>
		/// .
		/// </returns>
