...
namespace Lucene.Net.Analysis.GL
{
	...
	/// 	</see>
	/// that applies
	/// <see cref="GalicianStemmer">GalicianStemmer</see>
	/// to stem
	/// Galician words.
	/// <p>
	...
	{
	    private readonly GalicianStemmer stemmer;
		...
		public override bool IncrementToken()
		{
			if (input.IncrementToken())
			{
				...
				{
					// this stemmer increases word length by 1: worst case '*Ã§om' -> '*ciÃ³n'
