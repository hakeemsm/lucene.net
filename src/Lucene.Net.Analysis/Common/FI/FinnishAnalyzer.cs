...
namespace Lucene.Net.Analysis.FI
{
	...
	public sealed class FinnishAnalyzer : StopwordAnalyzerBase
	{
		...
		public static readonly string DEFAULT_STOPWORD_FILE = "finnish_stop.txt";
		...
		/// .
		/// </summary>
		protected internal FinnishAnalyzer(Version matchVersion) : this(matchVersion, FinnishAnalyzer.DefaultSetHolder
			.DEFAULT_STOP_SET)
		{
		}
		...
		protected internal FinnishAnalyzer(Version matchVersion, CharArraySet stopwords) : 
		...
		public FinnishAnalyzer(Version matchVersion, CharArraySet stopwords, CharArraySet
