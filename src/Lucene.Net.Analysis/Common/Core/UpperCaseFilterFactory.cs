...
namespace Lucene.Net.Analysis.Core
{
	/// <summary>
	/// Factory for
	/// <see cref="UpperCaseFilter">UpperCaseFilter</see>
	/// .
	...
	/// <see cref="LowerCaseFilterFactory">LowerCaseFilterFactory</see>
	/// for
	/// general search matching
	/// </summary>
	public class UpperCaseFilterFactory : TokenFilterFactory, IMultiTermAwareComponent
	{
		/// <summary>Creates a new UpperCaseFilterFactory</summary>
		protected internal UpperCaseFilterFactory(IDictionary<string, string> args) : base
			(args)
		{
			AssureMatchVersion();
			if (!args.Any())
		...
		{
			return new UpperCaseFilter(luceneMatchVersion.Value, input);
		}
