...
namespace Lucene.Net.Analysis.CZ
{
	/// <summary>
	/// Factory for
	/// <see cref="CzechStemFilter">CzechStemFilter</see>
	/// .
	...
	{
		/// <summary>Creates a new CzechStemFilterFactory</summary>
		protected internal CzechStemFilterFactory(IDictionary<string, string> args) : base(args)
		{
			if (args.Any())
			{
