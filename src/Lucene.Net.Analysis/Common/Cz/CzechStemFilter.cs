...
namespace Lucene.Net.Analysis.CZ
{
	...
	/// 	</see>
	/// that applies
	/// <see cref="CzechStemmer">CzechStemmer</see>
	/// to stem Czech words.
	/// <p>
	...
	/// </summary>
	/// <seealso cref="Lucene.Net.Analysis.Miscellaneous.SetKeywordMarkerFilter">Lucene.Net.Analysis.Miscellaneous.SetKeywordMarkerFilter
	/// 	</seealso>
