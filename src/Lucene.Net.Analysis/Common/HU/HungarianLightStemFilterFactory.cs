...
namespace Lucene.Net.Analysis.HU
{
	/// <summary>
	/// Factory for
	/// <see cref="HungarianLightStemFilter">HungarianLightStemFilter</see>
	/// .
	...
	{
		/// <summary>Creates a new HungarianLightStemFilterFactory</summary>
		protected internal HungarianLightStemFilterFactory(IDictionary<string, string> args
			) : base(args)
		{
			if (args.Any())
			{
