...
namespace Lucene.Net.Analysis.HU
{
	...
	public sealed class HungarianAnalyzer : StopwordAnalyzerBase
	{
		...
		/// <summary>File containing default Hungarian stopwords.</summary>
		/// <remarks>File containing default Hungarian stopwords.</remarks>
		public static readonly string DEFAULT_STOPWORD_FILE = "hungarian_stop.txt";
		...
		{
			return HungarianAnalyzer.DefaultSetHolder.DEFAULT_STOP_SET;
		}
		...
		/// .
		/// </summary>
		protected internal HungarianAnalyzer(Version matchVersion) : this(matchVersion, HungarianAnalyzer.DefaultSetHolder
			.DEFAULT_STOP_SET)
		{
		}
		...
		protected internal HungarianAnalyzer(Version matchVersion, CharArraySet stopwords
		...
		public HungarianAnalyzer(Version matchVersion, CharArraySet stopwords, CharArraySet
