...
namespace Lucene.Net.Analysis.IN
{
	/// <summary>
	/// Factory for
	/// <see cref="IndicNormalizationFilter">IndicNormalizationFilter</see>
	/// .
	...
	{
		/// <summary>Creates a new IndicNormalizationFilterFactory</summary>
		protected internal IndicNormalizationFilterFactory(IDictionary<string, string> args
			) : base(args)
		{
			if (args.Any())
			{
