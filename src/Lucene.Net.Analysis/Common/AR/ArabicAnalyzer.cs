...
namespace Lucene.Net.Analysis.Common.AR
{
	/// <summary>
	/// <see cref="Lucene.Net.Analysis.Analyzer">Lucene.Analysis.Analyzer
	/// 	</see>
	/// for Arabic.
	/// <p>
	...
	/// <ul>
	/// <li>
	/// <see cref="ArabicNormalizationFilter">ArabicNormalizationFilter</see>
	/// : Arabic orthographic normalization.
	/// <li>
	/// <see cref="ArabicStemFilter">ArabicStemFilter</see>
	/// : Arabic light stemming
	/// <li>Arabic stop words file: a set of default Arabic stop words.</li></li></li>
	/// </ul></p></p>
	/// </summary>
     
    public sealed class ArabicAnalyzer : StopwordAnalyzerBase
    {
		/// <summary>File containing default Arabic stopwords.</summary>
		/// <remarks>
		/// File containing default Arabic stopwords.
		/// Default stopword list is from http://members.unine.ch/jacques.savoy/clef/index.html
		/// The stopword list is BSD-Licensed.
		/// </remarks>
		public static readonly string DEFAULT_STOPWORD_FILE = "ArabicStopWords.txt";
		...
		/// .
		/// </summary>
		protected internal ArabicAnalyzer(Version matchVersion) : this(matchVersion, ArabicAnalyzer.DefaultSetHolder
			.DEFAULT_STOP_SET)
		{
		}
		...
		protected internal ArabicAnalyzer(Version matchVersion, CharArraySet stopwords) : 
		...
		/// <see cref="Lucene.Net.Analysis.Miscellaneous.SetKeywordMarkerFilter">Lucene.Analysis.Miscellaneous.SetKeywordMarkerFilter
		/// 	</see>
		/// before
		/// <see cref="ArabicStemFilter">ArabicStemFilter</see>
		/// .
		...
		/// 	</see>
		/// built from an
		/// <see cref="Lucene.Analysis.Standard.StandardTokenizer">Lucene.Analysis.Standard.StandardTokenizer
		/// 	</see>
		/// filtered with
