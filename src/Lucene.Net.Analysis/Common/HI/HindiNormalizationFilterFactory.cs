...
namespace Lucene.Net.Analysis.HI
{
	...
	{
		/// <summary>Creates a new HindiNormalizationFilterFactory</summary>
		protected internal HindiNormalizationFilterFactory(IDictionary<string, string> args) : base(args)
		{
			if (args.Any())
			{
