...
namespace Lucene.Net.Expressions.JS
{
	...
	{
		public static readonly string[] tokenNames = new string[] { "<invalid>", "<EOR>", 
		...
		public JavascriptParser(TokenStream input) : this(input, new RecognizerSharedState
			())
		{
		}

		public JavascriptParser(TokenStream input, RecognizerSharedState state) : base(input
			, state)
		{
		}

		protected internal TreeAdaptor adaptor = new CommonTreeAdaptor();

		// delegators
		public virtual void SetTreeAdaptor(TreeAdaptor adaptor)
		{
			this.adaptor = adaptor;
		}

		public virtual TreeAdaptor GetTreeAdaptor()
		{
			return adaptor;
		}
		...
		{
			return Lucene.Net.Expressions.JS.JavascriptParser.tokenNames;
		}
			 ...
			 re)
		{
			...
			else
			{
				...
				else
				{
					...
					{
						message = " missing " + GetReadableTokenString(re.token) + " at position (" + re.
							charPositionInLine + ").";
					}
					else
					{
		...
		/// <exception cref="Org.Antlr.Runtime.RecognitionException"></exception>
		public JavascriptParser.Conditional_return Conditional()
		{
		...
		public class Logical_or_return : ParserRuleReturnScope
		{
			internal CommonTree tree;
		...
		/// <exception cref="Org.Antlr.Runtime.RecognitionException"></exception>
		public JavascriptParser.Logical_or_return Logical_or()
		{
...
loop2_break: ;
		...
		public class Logical_and_return : ParserRuleReturnScope
		{
			internal CommonTree tree;
		...
		/// <exception cref="Org.Antlr.Runtime.RecognitionException"></exception>
		public JavascriptParser.Logical_and_return Logical_and()
		{
...
loop3_break: ;
		...
		public class Bitwise_or_return : ParserRuleReturnScope
		{
			internal CommonTree tree;
		...
		/// <exception cref="Org.Antlr.Runtime.RecognitionException"></exception>
		public JavascriptParser.Bitwise_or_return Bitwise_or()
		{
...
loop4_break: ;
		...
		public class Bitwise_xor_return : ParserRuleReturnScope
		{
			internal CommonTree tree;
		...
		/// <exception cref="Org.Antlr.Runtime.RecognitionException"></exception>
		public JavascriptParser.Bitwise_xor_return Bitwise_xor()
		{
...
loop5_break: ;
		...
		public class Bitwise_and_return : ParserRuleReturnScope
		{
			internal CommonTree tree;
		...
		/// <exception cref="Org.Antlr.Runtime.RecognitionException"></exception>
		public JavascriptParser.Bitwise_and_return Bitwise_and()
		{
...
loop6_break: ;
		...
		/// <exception cref="Org.Antlr.Runtime.RecognitionException"></exception>
		public JavascriptParser.Equality_return Equality()
		{
...
loop7_break: ;
		...
		public class Relational_return : ParserRuleReturnScope
		{
			internal CommonTree tree;
		...
		/// <exception cref="Org.Antlr.Runtime.RecognitionException"></exception>
		public JavascriptParser.Relational_return Relational()
		{
...
loop8_break: ;
		...
		public class Shift_return : ParserRuleReturnScope
		{
			internal CommonTree tree;
		...
		/// <exception cref="Org.Antlr.Runtime.RecognitionException"></exception>
		public JavascriptParser.Shift_return Shift()
		{
...
loop9_break: ;
		...
		public class Additive_return : ParserRuleReturnScope
		{
			internal CommonTree tree;
		...
		/// <exception cref="Org.Antlr.Runtime.RecognitionException"></exception>
		public JavascriptParser.Additive_return Additive()
		{
...
loop10_break: ;
		...
		public class Multiplicative_return : ParserRuleReturnScope
		{
			internal CommonTree tree;
		...
		/// <exception cref="Org.Antlr.Runtime.RecognitionException"></exception>
		public JavascriptParser.Multiplicative_return Multiplicative()
		{
...
loop11_break: ;
		...
		/// <exception cref="Org.Antlr.Runtime.RecognitionException"></exception>
		public JavascriptParser.Unary_return Unary()
		{
		...
		/// <exception cref="Org.Antlr.Runtime.RecognitionException"></exception>
		public JavascriptParser.Unary_operator_return Unary_operator()
		{
				...
				switch (alt13)
				{
					case 1:
					{
						...
						RewriteRuleSubtreeStream stream_retval = new RewriteRuleSubtreeStream(adaptor, "rule retval"
							, retval != null ? ((CommonTree)retval.GetTree()) : null);
						root_0 = (CommonTree)adaptor.Nil();
						{
							// 305:19: -> AT_NEGATE
		...
		public class Postfix_return : ParserRuleReturnScope
		{
			internal CommonTree tree;
		...
		/// <exception cref="Org.Antlr.Runtime.RecognitionException"></exception>
		public JavascriptParser.Postfix_return Postfix()
		{
			...
			RewriteRuleTokenStream stream_NAMESPACE_ID = new RewriteRuleTokenStream(adaptor, 
				"token NAMESPACE_ID");
		...
		/// <exception cref="Org.Antlr.Runtime.RecognitionException"></exception>
		public JavascriptParser.Primary_return Primary()
		{
...
loop16_break: ;
		...
		/// <exception cref="Org.Antlr.Runtime.RecognitionException"></exception>
		public JavascriptParser.Numeric_return Numeric()
		{
		...
		public static readonly BitSet FOLLOW_conditional_in_expression737 = new BitSet(new 
			long[] { unchecked((long)(0x0000000000000000L)) });

		public static readonly BitSet FOLLOW_EOF_in_expression739 = new BitSet(new long[]
			 { unchecked((long)(0x0000000000000002L)) });

		public static readonly BitSet FOLLOW_logical_or_in_conditional757 = new BitSet(new 
			long[] { unchecked((long)(0x0000000001000002L)) });

		public static readonly BitSet FOLLOW_AT_COND_QUE_in_conditional760 = new BitSet(new 
			long[] { unchecked((long)(0x0000032308002050L)) });

		public static readonly BitSet FOLLOW_conditional_in_conditional763 = new BitSet(new 
			long[] { unchecked((long)(0x0000000000010000L)) });

		public static readonly BitSet FOLLOW_AT_COLON_in_conditional765 = new BitSet(new 
			long[] { unchecked((long)(0x0000032308002050L)) });

		public static readonly BitSet FOLLOW_conditional_in_conditional768 = new BitSet(new 
			long[] { unchecked((long)(0x0000000000000002L)) });

		public static readonly BitSet FOLLOW_logical_and_in_logical_or787 = new BitSet(new 
			long[] { unchecked((long)(0x0000000000004002L)) });

		public static readonly BitSet FOLLOW_AT_BOOL_OR_in_logical_or790 = new BitSet(new 
			long[] { unchecked((long)(0x0000032308002050L)) });

		public static readonly BitSet FOLLOW_logical_and_in_logical_or793 = new BitSet(new 
			long[] { unchecked((long)(0x0000000000004002L)) });

		public static readonly BitSet FOLLOW_bitwise_or_in_logical_and812 = new BitSet(new 
			long[] { unchecked((long)(0x0000000000001002L)) });

		public static readonly BitSet FOLLOW_AT_BOOL_AND_in_logical_and815 = new BitSet(new 
			long[] { unchecked((long)(0x0000032308002050L)) });

		public static readonly BitSet FOLLOW_bitwise_or_in_logical_and818 = new BitSet(new 
			long[] { unchecked((long)(0x0000000000001002L)) });

		public static readonly BitSet FOLLOW_bitwise_xor_in_bitwise_or837 = new BitSet(new 
			long[] { unchecked((long)(0x0000000000000082L)) });

		public static readonly BitSet FOLLOW_AT_BIT_OR_in_bitwise_or840 = new BitSet(new 
			long[] { unchecked((long)(0x0000032308002050L)) });

		public static readonly BitSet FOLLOW_bitwise_xor_in_bitwise_or843 = new BitSet(new 
			long[] { unchecked((long)(0x0000000000000082L)) });

		public static readonly BitSet FOLLOW_bitwise_and_in_bitwise_xor862 = new BitSet(new 
			long[] { unchecked((long)(0x0000000000000802L)) });

		public static readonly BitSet FOLLOW_AT_BIT_XOR_in_bitwise_xor865 = new BitSet(new 
			long[] { unchecked((long)(0x0000032308002050L)) });

		public static readonly BitSet FOLLOW_bitwise_and_in_bitwise_xor868 = new BitSet(new 
			long[] { unchecked((long)(0x0000000000000802L)) });

		public static readonly BitSet FOLLOW_equality_in_bitwise_and888 = new BitSet(new 
			long[] { unchecked((long)(0x0000000000000022L)) });

		public static readonly BitSet FOLLOW_AT_BIT_AND_in_bitwise_and891 = new BitSet(new 
			long[] { unchecked((long)(0x0000032308002050L)) });

		public static readonly BitSet FOLLOW_equality_in_bitwise_and894 = new BitSet(new 
			long[] { unchecked((long)(0x0000000000000022L)) });

		public static readonly BitSet FOLLOW_relational_in_equality913 = new BitSet(new long
			[] { unchecked((long)(0x0000000000840002L)) });

		public static readonly BitSet FOLLOW_set_in_equality916 = new BitSet(new long[] { 
			unchecked((long)(0x0000032308002050L)) });

		public static readonly BitSet FOLLOW_relational_in_equality925 = new BitSet(new long
			[] { unchecked((long)(0x0000000000840002L)) });

		public static readonly BitSet FOLLOW_shift_in_relational944 = new BitSet(new long
			[] { unchecked((long)(0x0000000000780002L)) });

		public static readonly BitSet FOLLOW_set_in_relational947 = new BitSet(new long[]
			 { unchecked((long)(0x0000032308002050L)) });

		public static readonly BitSet FOLLOW_shift_in_relational964 = new BitSet(new long
			[] { unchecked((long)(0x0000000000780002L)) });

		public static readonly BitSet FOLLOW_additive_in_shift983 = new BitSet(new long[]
			 { unchecked((long)(0x0000000000000702L)) });

		public static readonly BitSet FOLLOW_set_in_shift986 = new BitSet(new long[] { unchecked(
			(long)(0x0000032308002050L)) });

		public static readonly BitSet FOLLOW_additive_in_shift999 = new BitSet(new long[]
			 { unchecked((long)(0x0000000000000702L)) });

		public static readonly BitSet FOLLOW_multiplicative_in_additive1018 = new BitSet(
			new long[] { unchecked((long)(0x0000000100000012L)) });

		public static readonly BitSet FOLLOW_set_in_additive1021 = new BitSet(new long[] 
			{ unchecked((long)(0x0000032308002050L)) });

		public static readonly BitSet FOLLOW_multiplicative_in_additive1030 = new BitSet(
			new long[] { unchecked((long)(0x0000000100000012L)) });

		public static readonly BitSet FOLLOW_unary_in_multiplicative1049 = new BitSet(new 
			long[] { unchecked((long)(0x0000000032000002L)) });

		public static readonly BitSet FOLLOW_set_in_multiplicative1052 = new BitSet(new long
			[] { unchecked((long)(0x0000032308002050L)) });

		public static readonly BitSet FOLLOW_unary_in_multiplicative1065 = new BitSet(new 
			long[] { unchecked((long)(0x0000000032000002L)) });

		public static readonly BitSet FOLLOW_postfix_in_unary1084 = new BitSet(new long[]
			 { unchecked((long)(0x0000000000000002L)) });

		public static readonly BitSet FOLLOW_AT_ADD_in_unary1092 = new BitSet(new long[] 
			{ unchecked((long)(0x0000032308002050L)) });

		public static readonly BitSet FOLLOW_unary_in_unary1095 = new BitSet(new long[] { 
			unchecked((long)(0x0000000000000002L)) });

		public static readonly BitSet FOLLOW_unary_operator_in_unary1103 = new BitSet(new 
			long[] { unchecked((long)(0x0000032308002050L)) });

		public static readonly BitSet FOLLOW_unary_in_unary1106 = new BitSet(new long[] { 
			unchecked((long)(0x0000000000000002L)) });

		public static readonly BitSet FOLLOW_AT_SUBTRACT_in_unary_operator1123 = new BitSet
			(new long[] { unchecked((long)(0x0000000000000002L)) });

		public static readonly BitSet FOLLOW_AT_BIT_NOT_in_unary_operator1135 = new BitSet
			(new long[] { unchecked((long)(0x0000000000000002L)) });

		public static readonly BitSet FOLLOW_AT_BOOL_NOT_in_unary_operator1143 = new BitSet
			(new long[] { unchecked((long)(0x0000000000000002L)) });

		public static readonly BitSet FOLLOW_primary_in_postfix1160 = new BitSet(new long
			[] { unchecked((long)(0x0000000000000002L)) });

		public static readonly BitSet FOLLOW_NAMESPACE_ID_in_postfix1168 = new BitSet(new 
			long[] { unchecked((long)(0x0000000008000000L)) });

		public static readonly BitSet FOLLOW_arguments_in_postfix1170 = new BitSet(new long
			[] { unchecked((long)(0x0000000000000002L)) });

		public static readonly BitSet FOLLOW_NAMESPACE_ID_in_primary1198 = new BitSet(new 
			long[] { unchecked((long)(0x0000000000000002L)) });

		public static readonly BitSet FOLLOW_numeric_in_primary1206 = new BitSet(new long
			[] { unchecked((long)(0x0000000000000002L)) });

		public static readonly BitSet FOLLOW_AT_LPAREN_in_primary1214 = new BitSet(new long
			[] { unchecked((long)(0x0000032308002050L)) });

		public static readonly BitSet FOLLOW_conditional_in_primary1217 = new BitSet(new 
			long[] { unchecked((long)(0x0000000080000000L)) });

		public static readonly BitSet FOLLOW_AT_RPAREN_in_primary1219 = new BitSet(new long
			[] { unchecked((long)(0x0000000000000002L)) });

		public static readonly BitSet FOLLOW_AT_LPAREN_in_arguments1237 = new BitSet(new 
			long[] { unchecked((long)(0x0000032388002050L)) });

		public static readonly BitSet FOLLOW_conditional_in_arguments1241 = new BitSet(new 
			long[] { unchecked((long)(0x0000000080020000L)) });

		public static readonly BitSet FOLLOW_AT_COMMA_in_arguments1244 = new BitSet(new long
			[] { unchecked((long)(0x0000032308002050L)) });

		public static readonly BitSet FOLLOW_conditional_in_arguments1247 = new BitSet(new 
			long[] { unchecked((long)(0x0000000080020000L)) });

		public static readonly BitSet FOLLOW_AT_RPAREN_in_arguments1253 = new BitSet(new 
			long[] { unchecked((long)(0x0000000000000002L)) });
		// $ANTLR end "numeric"
		// Delegated rules
	}
