...
namespace Lucene.Net.Expressions.JS
{
	internal class JavascriptLexer : Lexer
	{
		...
		public override void DisplayRecognitionError(string[] tokenNames, RecognitionException
			 re)
		{
			string message = " unexpected character '" + (char)re.c + "' at position (" + re.
				charPositionInLine + ").";
		...
		public JavascriptLexer(CharStream input) : this(input, new RecognizerSharedState(
			))
		{
			dfa9 = new JavascriptLexer.DFA9(this, this);
		}

		public JavascriptLexer(CharStream input, RecognizerSharedState state) : base(input
			, state)
		{
			dfa9 = new JavascriptLexer.DFA9(this, this);
		}
