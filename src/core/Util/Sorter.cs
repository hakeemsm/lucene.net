...
{
	/// <summary>Base class for sorting algorithms implementations.</summary>
	/// <remarks>Base class for sorting algorithms implementations.</remarks>
	/// <lucene.internal></lucene.internal>
	public abstract class Sorter
	{
		internal const int THRESHOLD = 20;

	    /// <summary>Compare entries found in slots <code>i</code> and <code>j</code>.</summary>
		/// <remarks>
		/// Compare entries found in slots <code>i</code> and <code>j</code>.
		/// The contract for the returned value is the same as
		/// <see cref="Support.Compare">System.Collections.IEnumerator&lt;T&gt;.Compare(object, object)
		/// 	</see>
		/// .
		/// </remarks>
		protected internal abstract int Compare(int i, int j);

		/// <summary>Swap values at slots <code>i</code> and <code>j</code>.</summary>
		/// <remarks>Swap values at slots <code>i</code> and <code>j</code>.</remarks>
		...
		internal virtual void SiftDown(int i, int from, int to)
		{
				...
				, i))
			{
				...
				{
					if (rightChild < to && Compare(i, rightChild) < 0)
					{
						Swap(i, rightChild);
						i = rightChild;
					}
