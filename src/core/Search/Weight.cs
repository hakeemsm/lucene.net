...
namespace Lucene.Net.Search
{
    ...
    public abstract class Weight
    {
        ...
        /// query.
        /// 
        public abstract Scorer Scorer(AtomicReaderContext context, IBits acceptDocs);
        /// </summary>
        /// <param name="reader">
        ...
        /// </returns>
        public virtual BulkScorer BulkScorer(AtomicReaderContext context, bool scoreDocsInOrder, IBits acceptDocs)
        {
            var scorer = Scorer(context, acceptDocs);
            if (scorer == null)
            {
                // No docs match
                return null;
        ...
        internal class DefaultBulkScorer : BulkScorer
        {
            ...
            /// <exception cref="System.IO.IOException"></exception>
            internal static bool ScoreRange(Collector collector, Scorer scorer, int currentDoc
                , int end)
            {
