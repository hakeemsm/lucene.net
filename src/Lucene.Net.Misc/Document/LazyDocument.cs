...
namespace Lucene.Net.Document
{
	...
	/// </remarks>
	/// <seealso cref="GetField(Lucene.Net.Index.FieldInfo)">GetField(Lucene.Net.Index.FieldInfo)
	/// 	</seealso>
	public class LazyDocument
	{
		...
		internal virtual Lucene.Net.Document.Document GetDocument()
		{
			lock (this)
			{
				if (doc == null)
		...
		{
			Lucene.Net.Document.Document d = GetDocument();
