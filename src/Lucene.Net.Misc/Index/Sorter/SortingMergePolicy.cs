...
namespace Lucene.Net.Index.Sorter
{
	/// <summary>
	/// A
	/// <see cref="Lucene.Net.Index.MergePolicy">Lucene.Net.Index.MergePolicy
	/// 	</see>
	...
	/// <see cref="Lucene.Net.Index.IndexWriter.AddDocuments(Sharpen.Iterable{T}, Lucene.Net.Analysis.Analyzer)
	...
	/// <see cref="Lucene.Net.Search.Sort.INDEXORDER">Lucene.Net.Search.Sort.INDEXORDER
	/// 	</see>
	...
	public sealed class SortingMergePolicy : MergePolicy
	{
		/// <summary>
		/// Put in the
		/// <see cref="Lucene.Net.Index.SegmentInfo.GetDiagnostics()">diagnostics</see>
		/// to denote that
		...
		internal readonly Lucene.Net.Index.Sorter.Sorter sorter;
		...
		{
			this.@in = @in;
			this.sorter = new Lucene.Net.Index.Sorter.Sorter(sort);
			this.sort = sort;
		}
