...
namespace Lucene.Net.Index.Sorter
{
	...
	public class SortingAtomicReader : FilterAtomicReader
	{
		private class SortingFields : FilterAtomicReader.FilterFields
		{
			...
			{
				Lucene.Net.Index.Terms terms = @in.Terms(field);
				if (terms == null)
				{
					return null;
				}
		...
		internal class SortingDocsEnum : FilterAtomicReader.FilterDocsEnum
		{
			...
			/// <summary>
			/// Returns the wrapped
			/// <see cref="Lucene.Net.Index.DocsEnum">Lucene.Net.Index.DocsEnum</see>
			/// .
			/// </summary>
		...
		internal class SortingDocsAndPositionsEnum : FilterAtomicReader.FilterDocsAndPositionsEnum
		{
			/// <summary>
			/// A
			/// <see cref="Lucene.Net.Util.TimSorter">Lucene.Net.Util.TimSorter</see>
			...
			/// <summary>
			/// Returns the wrapped
			/// <see cref="Lucene.Net.Index.DocsAndPositionsEnum">Lucene.Net.Index.DocsAndPositionsEnum
			/// 	</see>
			/// .
			/// </summary>
		...
		{
			return Wrap(reader, new Lucene.Net.Index.Sorter.Sorter(sort).Sort(reader));
		}

		/// <summary>
		/// Expert: same as
		/// <see cref="Wrap(Lucene.Net.Index.AtomicReader, Lucene.Net.Search.Sort)
		/// 	">Wrap(Lucene.Net.Index.AtomicReader, Lucene.Net.Search.Sort)</see>
		...
		internal static AtomicReader Wrap(AtomicReader reader, Sorter.DocMap docMap)
		{
			...
			return new SortingAtomicReader(Lucene.Net.Index.Sorter.Sorter.IsConsistent
				(docMap), docMap);
		}
