...
namespace Lucene.Net.Index.Sorter
{
	...
	/// <see cref="Lucene.Net.Search.TopDocsCollector{T}">Lucene.Net.Search.TopDocsCollector&lt;T&gt;
	/// 	</see>
	/// , and not e.g.
	/// <see cref="Lucene.Net.Search.TotalHitCountCollector">Lucene.Net.Search.TotalHitCountCollector
	/// 	</see>
	/// .
	/// <p>
	...
	/// <see cref="Lucene.Net.Search.TopDocsCollector{T}.TopDocs()">TopDocs</see>
	/// will be correct. However the total of
	/// <see cref="Lucene.Net.Search.TopDocsCollector{T}.GetTotalHits()">hit count
	/// 	</see>
	...
	/// <code>Collector</code>
	/// uses
	/// <see cref="Lucene.Net.Search.Sort.ToString()">Lucene.Net.Search.Sort.ToString()
	/// 	</see>
	/// to detect
