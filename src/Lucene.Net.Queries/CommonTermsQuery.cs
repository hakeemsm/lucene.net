...
namespace Lucene.Net.Queries
{
	...
	/// <see cref="Add(Lucene.Net.Index.Term)">added</see>
	/// terms: low-frequency
	...
	/// differences in the
	/// <see cref="Lucene.Net.Search.Similarities.Similarity.Coord(int, int)">number of leaf queries
	/// 	</see>
	...
	public class CommonTermsQuery : Query
	{
		...
		/// <see cref="Lucene.Net.Search.BooleanClause.Occur">Lucene.Net.Search.BooleanClause.Occur
		/// 	</see>
		...
		/// if
		/// <see cref="Lucene.Net.Search.BooleanClause.Occur.MUST_NOT">Lucene.Net.Search.BooleanClause.Occur.MUST_NOT
		/// 	</see>
		...
		/// disables
		/// <see cref="Lucene.Net.Search.Similarities.Similarity.Coord(int, int)">Lucene.Net.Search.Similarities.Similarity.Coord(int, int)
		/// 	</see>
		...
		public override bool Equals(object obj)
		{
			...
			Lucene.Net.Queries.CommonTermsQuery other = (Lucene.Net.Queries.CommonTermsQuery
				)obj;
