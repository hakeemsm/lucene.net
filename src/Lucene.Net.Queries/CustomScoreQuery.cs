...
namespace Lucene.Net.Queries
{
	...
	/// <see cref="GetCustomScoreProvider(Lucene.Net.Index.AtomicReaderContext)">GetCustomScoreProvider(Lucene.Net.Index.AtomicReaderContext)
	/// 	</see>
	/// .
	/// </summary>
	...
	public class CustomScoreQuery : Query
	{
		...
		{
			Lucene.Net.Queries.CustomScoreQuery clone = null;
			Query sq = subQuery.Rewrite(reader);
			if (sq != subQuery)
			{
				clone = ((Lucene.Net.Queries.CustomScoreQuery)Clone());
				clone.subQuery = sq;
			}
		...
		{
			Lucene.Net.Queries.CustomScoreQuery clone = (Lucene.Net.Queries.CustomScoreQuery
				)base.Clone();
		...
		public override bool Equals(object o)
		{
			...
			Lucene.Net.Queries.CustomScoreQuery other = (Lucene.Net.Queries.CustomScoreQuery
				)o;
		...
		private class CustomWeight : Weight
		{
			...
			public override Lucene.Net.Search.Scorer Scorer(AtomicReaderContext context
				, Bits acceptDocs)
			{
				Lucene.Net.Search.Scorer subQueryScorer = this.subQueryWeight.Scorer(context
					, acceptDocs);
				if (subQueryScorer == null)
				{
					return null;
				}
				Lucene.Net.Search.Scorer[] valSrcScorers = new Lucene.Net.Search.Scorer
