...
namespace Lucene.Net.Queries.Function.Valuesource
{
	...
	/// <see cref="Lucene.Net.Search.FieldCache.GetInts(Lucene.Net.Index.AtomicReader, string, bool)
	/// 	">Lucene.Net.Search.FieldCache.GetInts(Lucene.Net.Index.AtomicReader, string, bool)
	/// 	</see>
	/// and makes those
	...
	public class IntFieldSource : FieldCacheSource
	{
		...
		{
			if (o.GetType() != typeof(Lucene.Net.Queries.Function.Valuesource.IntFieldSource
				))
			{
				return false;
			}
			Lucene.Net.Queries.Function.Valuesource.IntFieldSource other = (Lucene.Net.Queries.Function.Valuesource.IntFieldSource
				)o;
