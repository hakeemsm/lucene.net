...
namespace Lucene.Net.Queries.Function.Valuesource
{
	...
	public class DoubleConstValueSource : ConstNumberSource
	{
		...
		{
			if (!(o is Lucene.Net.Queries.Function.Valuesource.DoubleConstValueSource))
			{
				return false;
			}
			Lucene.Net.Queries.Function.Valuesource.DoubleConstValueSource other = (Lucene.Net.Queries.Function.Valuesource.DoubleConstValueSource
				)o;
