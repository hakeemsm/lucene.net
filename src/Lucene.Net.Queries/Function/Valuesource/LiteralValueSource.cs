...
namespace Lucene.Net.Queries.Function.Valuesource
{
	...
	public class LiteralValueSource : ValueSource
	{
		...
		public override bool Equals(object o)
		{
			...
			if (!(o is Lucene.Net.Queries.Function.Valuesource.LiteralValueSource))
			{
				return false;
			}
			Lucene.Net.Queries.Function.Valuesource.LiteralValueSource that = (Lucene.Net.Queries.Function.Valuesource.LiteralValueSource
				)o;
			return @string.Equals(that.@string);
		}

		public static readonly int hash = typeof(Lucene.Net.Queries.Function.Valuesource.LiteralValueSource
			).GetHashCode();
