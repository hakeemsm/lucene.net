...
namespace Lucene.Net.Queries.Function.Valuesource
{
	...
	public class JoinDocFreqValueSource : FieldCacheSource
	{
		...
		{
			if (o.GetType() != typeof(Lucene.Net.Queries.Function.Valuesource.JoinDocFreqValueSource
				))
			{
				return false;
			}
			Lucene.Net.Queries.Function.Valuesource.JoinDocFreqValueSource other = (Lucene.Net.Queries.Function.Valuesource.JoinDocFreqValueSource
				)o;
