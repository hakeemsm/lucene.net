...
namespace Lucene.Net.Queries.Function.Valuesource
{
	...
	public class OrdFieldSource : ValueSource
	{
		...
		{
			return o != null && o.GetType() == typeof(Lucene.Net.Queries.Function.Valuesource.OrdFieldSource
				) && this.field.Equals(((Lucene.Net.Queries.Function.Valuesource.OrdFieldSource
				)o).field);
		}

		private static readonly int hcode = typeof(Lucene.Net.Queries.Function.Valuesource.OrdFieldSource
			).GetHashCode();
