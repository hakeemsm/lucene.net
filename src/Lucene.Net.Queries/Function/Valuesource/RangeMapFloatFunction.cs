...
namespace Lucene.Net.Queries.Function.Valuesource
{
	...
	public class RangeMapFloatFunction : ValueSource
	{
		...
		{
			if (typeof(Lucene.Net.Queries.Function.Valuesource.RangeMapFloatFunction) 
				!= o.GetType())
			{
				return false;
			}
			Lucene.Net.Queries.Function.Valuesource.RangeMapFloatFunction other = (Lucene.Net.Queries.Function.Valuesource.RangeMapFloatFunction
				)o;
