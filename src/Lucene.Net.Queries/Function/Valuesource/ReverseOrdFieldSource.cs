...
namespace Lucene.Net.Queries.Function.Valuesource
{
	...
	public class ReverseOrdFieldSource : ValueSource
	{
		...
		{
			if (o == null || (o.GetType() != typeof(Lucene.Net.Queries.Function.Valuesource.ReverseOrdFieldSource
				)))
			{
				return false;
			}
			Lucene.Net.Queries.Function.Valuesource.ReverseOrdFieldSource other = (Lucene.Net.Queries.Function.Valuesource.ReverseOrdFieldSource
				)o;
			return this.field.Equals(other.field);
		}

		private static readonly int hcode = typeof(Lucene.Net.Queries.Function.Valuesource.ReverseOrdFieldSource
			).GetHashCode();
