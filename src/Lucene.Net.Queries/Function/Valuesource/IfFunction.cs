...
namespace Lucene.Net.Queries.Function.Valuesource
{
	...
	public class IfFunction : BoolFunction
	{
		...
		{
			if (!(o is Lucene.Net.Queries.Function.Valuesource.IfFunction))
			{
				return false;
			}
			Lucene.Net.Queries.Function.Valuesource.IfFunction other = (Lucene.Net.Queries.Function.Valuesource.IfFunction
				)o;
