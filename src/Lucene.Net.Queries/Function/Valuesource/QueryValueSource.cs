...
namespace Lucene.Net.Queries.Function.Valuesource
{
	...
	public class QueryValueSource : ValueSource
	{
		...
		{
			if (typeof(Lucene.Net.Queries.Function.Valuesource.QueryValueSource) != o.
				GetType())
			{
				return false;
			}
			Lucene.Net.Queries.Function.Valuesource.QueryValueSource other = (Lucene.Net.Queries.Function.Valuesource.QueryValueSource
				)o;
