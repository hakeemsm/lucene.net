...
namespace Lucene.Net.Queries.Function.Valuesource
{
	...
	/// </summary>
	/// <seealso cref="Lucene.Net.Queries.Function.FunctionQuery">Lucene.Net.Queries.Function.FunctionQuery
	/// 	</seealso>
	public class ReciprocalFloatFunction : ValueSource
	{
		...
		{
			if (typeof(Lucene.Net.Queries.Function.Valuesource.ReciprocalFloatFunction
				) != o.GetType())
			{
				return false;
			}
			Lucene.Net.Queries.Function.Valuesource.ReciprocalFloatFunction other = (Lucene.Net.Queries.Function.Valuesource.ReciprocalFloatFunction
				)o;
