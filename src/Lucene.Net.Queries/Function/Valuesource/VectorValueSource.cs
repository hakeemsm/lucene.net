...
namespace Lucene.Net.Queries.Function.Valuesource
{
	...
	/// Converts individual ValueSource instances to leverage the FunctionValues *Val functions that work with multiple values,
	/// i.e.
	/// <see cref="Lucene.Net.Queries.Function.FunctionValues.DoubleVal(int, double[])
	/// 	">Lucene.Net.Queries.Function.FunctionValues.DoubleVal(int, double[])</see>
	/// </remarks>
	public class VectorValueSource : MultiValueSource
	{
		...
		public override bool Equals(object o)
		{
			...
			if (!(o is Lucene.Net.Queries.Function.Valuesource.VectorValueSource))
			{
				return false;
			}
			Lucene.Net.Queries.Function.Valuesource.VectorValueSource that = (Lucene.Net.Queries.Function.Valuesource.VectorValueSource
				)o;
