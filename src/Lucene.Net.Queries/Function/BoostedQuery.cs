...
namespace Lucene.Net.Queries.Function
{
	...
	public class BoostedQuery : Query
	{
		...
		public override Query Rewrite(IndexReader reader)
		{
			...
			Lucene.Net.Queries.Function.BoostedQuery bq = (Lucene.Net.Queries.Function.BoostedQuery
				)this.Clone();
			bq.q = newQ;
			return bq;
		}
		...
		private class BoostedWeight : Weight
		{
			...
			public override Lucene.Net.Search.Scorer Scorer(AtomicReaderContext context
				, Bits acceptDocs)
			{
				Lucene.Net.Search.Scorer subQueryScorer = this.qWeight.Scorer(context, acceptDocs
					);
