...
namespace Lucene.Net.Queries
{
	...
	/// <see cref="CustomScoreQuery.GetCustomScoreProvider(Lucene.Net.Index.AtomicReaderContext)
	/// 	">CustomScoreQuery.GetCustomScoreProvider(Lucene.Net.Index.AtomicReaderContext)
	/// 	</see>
	/// , if you want
	...
	public class CustomScoreProvider
	{
		...
		/// If the number of
		/// <see cref="Lucene.Net.Queries.Function.FunctionQuery">function queries</see>
		/// is always &lt; 2 it is
