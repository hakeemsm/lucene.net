...
namespace Lucene.Net.Grouping.Function
{
    ...
    public class FunctionDistinctValuesCollector : AbstractDistinctValuesCollector<GroupCount>
    {
        ...
        public FunctionDistinctValuesCollector(IDictionary vsContext, ValueSource
    ...
    /// <lucene.experimental></lucene.experimental>
    public class GroupCount : GroupCount<MutableValue>
    {
        public GroupCount(MutableValue groupValue)
            : base(groupValue)
        {
        }
    }
