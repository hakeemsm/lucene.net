...
namespace Lucene.Net.Index.Memory
{
	...
	/// <see cref="Lucene.Net.Store.RAMDirectory">Lucene.Net.Store.RAMDirectory
	/// 	</see>
	...
	public class MemoryIndex
	{
		...
		/// <see cref="Lucene.Net.Document.Field">Lucene.Net.Document.Field</see>
		...
		/// <see cref="AddField(string, Lucene.Net.Analysis.TokenStream)">AddField(string, Lucene.Net.Analysis.TokenStream)
		/// 	</see>
		...
		/// <seealso cref="Lucene.Net.Document.Field.SetBoost(float)">Lucene.Net.Document.Field.SetBoost(float)
		/// 	</seealso>
		...
		private sealed class MemoryIndexReader : AtomicReader
		{
			...
			private class MemoryFields : Fields
			{
				...
				private sealed class _Terms_838 : Lucene.Net.Index.Terms
				{
